...
public class IzracunBrzine {
    private double lon1;
    private double lat1;
    private double lon2;
    private double lat2;

    public IzracunBrzine(double lon1, double lat1, double lon2, double lat2) {
        this.lon1 = lon1;
        this.lat1 = lat1;
        this.lon2 = lon2;
        this.lat2 = lat2;
    ...
    public double izracunajBrzinu(double vrijeme){
       ...
       return brzinaUKilometrimaNaSat;
    }
}
