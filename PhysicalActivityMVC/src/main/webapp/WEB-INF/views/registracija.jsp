...
<sf:label path="OIB"
cssErrorClass="error">OIB</sf:label>:<br>
<sf:input path="OIB"/><br>
<sf:label path="ime"
cssErrorClass="error">Ime</sf:label>:<br>
<sf:input path="ime"/><br>
<sf:label path="prezime"
cssErrorClass="error">Prezime</sf:label>:<br>
<sf:input path="prezime"/><br>
<sf:label path="spol"
cssErrorClass="error">Spol</sf:label>:<br>
<sf:select path="spol"><sf:option value="m">Muško</sf:option><sf:option value="f">Žensko</sf:option></sf:select>

<br>
<sf:label path="datumr"
cssErrorClass="error">Datum rođenja</sf:label>:<br>
<sf:input path="datumr" type="date" />
<br>
<sf:label path="email"
cssErrorClass="error">E-mail adresa</sf:label>:<br>
<sf:input path="email" /><br>
<sf:label path="sifra"
cssErrorClass="error">Šifra</sf:label>:<br>
<sf:password path="sifra"/><br>
